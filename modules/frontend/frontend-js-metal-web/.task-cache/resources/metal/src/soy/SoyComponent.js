define("frontend-js-metal-web@1.0.0/metal/src/soy/SoyComponent", ['exports', 'module', 'soyutils', 'metal/src/core', 'metal/src/dom/dom', 'metal/src/object/object', 'metal/src/component/Component', 'metal/src/component/ComponentRegistry', 'metal/src/soy/SoyComponentAop'], function (exports, module, _soyutils, _metalSrcCore, _metalSrcDomDom, _metalSrcObjectObject, _metalSrcComponentComponent, _metalSrcComponentComponentRegistry, _metalSrcSoySoyComponentAop) {
	'use strict';
   ...
   */
    ...
    */
			...
			value: function buildElementSurfaceData_() {
				...
				if (templates.content) {
					data.renderAttrs = _SoyComponentAop['default'].getOriginalFn(templates.content).params;
				}
				return data;
			}
    ...
    */
			value: function created_() {
				...
				_get(Object.getPrototypeOf(SoyComponent.prototype), 'created_', this).call(this);
			}
...
//# sourceMappingURL=SoyComponent.js.map