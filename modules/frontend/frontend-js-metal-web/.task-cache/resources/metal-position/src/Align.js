define("frontend-js-metal-web@1.0.0/metal-position/src/Align", ['exports', 'module', 'metal-position/src/Position'], function (exports, module, _metalPositionSrcPosition) {
	'use strict';
			...
			value: function align(element, alignElement, position) {
				...
				if (computedStyle.getPropertyValue('position') !== 'fixed') {
					...
					while (offsetParent = offsetParent.offsetParent) {
						bestRegion.top -= _Position['default'].getOffsetTop(offsetParent);
						bestRegion.left -= _Position['default'].getOffsetLeft(offsetParent);
					}
				}
