define("frontend-js-metal-web@1.0.0/metal-drag-drop/src/Drag", ['exports', 'module', 'metal/src/core', 'metal/src/dom/dom', 'metal/src/object/object', 'metal/src/attribute/Attribute', 'metal-drag-drop/src/helpers/DragAutoScroll', 'metal-drag-drop/src/helpers/DragScrollDelta', 'metal-drag-drop/src/helpers/DragShim', 'metal/src/events/EventHandler', 'metal-position/src/Position'], function (exports, module, _metalSrcCore, _metalSrcDomDom, _metalSrcObjectObject, _metalSrcAttributeAttribute, _metalDragDropSrcHelpersDragAutoScroll, _metalDragDropSrcHelpersDragScrollDelta, _metalDragDropSrcHelpersDragShim, _metalSrcEventsEventHandler, _metalPositionSrcPosition) {
	'use strict';
   ...
   */
    ...
    */
			...
			value: function calculateInitialPosition_(event) {
				this.sourceRegion_ = _object['default'].mixin({}, _Position['default'].getRegion(this.activeDragSource_, true));
				this.sourceRelativePos_ = {
					x: this.activeDragSource_.offsetLeft,
					y: this.activeDragSource_.offsetTop
				};
				if (_core['default'].isDef(event.clientX)) {
					this.mousePos_ = {
						x: event.clientX,
						y: event.clientY
					};
    ...
    */
			...
			value: function updatePositionFromDelta(deltaX, deltaY) {
				var newRegion = _object['default'].mixin({}, this.sourceRegion_);
